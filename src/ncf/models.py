...
class GMF(RecommenderSystem):
    ...
    def __init__(self, config: Dict):
        ...
        self.embedding_user = torch.nn.Embedding(num_embeddings=self.hparams.num_repos,
                                                 embedding_dim=self.hparams.latent_dim_mf)
        self.embedding_item = torch.nn.Embedding(num_embeddings=self.hparams.num_libs,
                                                 embedding_dim=self.hparams.latent_dim_mf)
